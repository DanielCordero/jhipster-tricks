...
import { VariableFrontComponent } from 'app/entities/variable-front/variable-front.component';
...
describe('Component Tests', () => {
    describe('VariableFront Management Component', () => {
        let comp: VariableFrontComponent;
        let fixture: ComponentFixture<VariableFrontComponent>;
        let service: VariableFrontService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [AplicacionTestModule],
                declarations: [VariableFrontComponent],
                providers: [
                    {
                ...
                .overrideTemplate(VariableFrontComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(VariableFrontComponent);
