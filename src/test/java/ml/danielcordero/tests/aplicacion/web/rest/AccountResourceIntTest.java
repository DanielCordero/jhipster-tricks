...
import ml.danielcordero.tests.aplicacion.config.Constants;
import ml.danielcordero.tests.aplicacion.AplicacionApp;
import ml.danielcordero.tests.aplicacion.domain.Authority;
import ml.danielcordero.tests.aplicacion.domain.User;
import ml.danielcordero.tests.aplicacion.repository.AuthorityRepository;
import ml.danielcordero.tests.aplicacion.repository.UserRepository;
import ml.danielcordero.tests.aplicacion.security.AuthoritiesConstants;
import ml.danielcordero.tests.aplicacion.service.MailService;
import ml.danielcordero.tests.aplicacion.service.dto.UserDTO;
import ml.danielcordero.tests.aplicacion.service.dto.PasswordChangeDTO;
import ml.danielcordero.tests.aplicacion.web.rest.errors.ExceptionTranslator;
import ml.danielcordero.tests.aplicacion.web.rest.vm.KeyAndPasswordVM;
import ml.danielcordero.tests.aplicacion.web.rest.vm.ManagedUserVM;
import ml.danielcordero.tests.aplicacion.service.UserService;
