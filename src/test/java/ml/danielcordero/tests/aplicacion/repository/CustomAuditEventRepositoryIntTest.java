...
import ml.danielcordero.tests.aplicacion.config.audit.AuditEventConverter;
import ml.danielcordero.tests.aplicacion.domain.PersistentAuditEvent;
...
import static ml.danielcordero.tests.aplicacion.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
